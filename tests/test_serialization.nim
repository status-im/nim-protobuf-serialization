import
  ...
  faststreams/inputs,
  serialization, serialization/object_serialization
...
type
  ...
  #[AnonTuple* = (SInt(int), string, float64)

  AbcTuple* = tuple[a: SInt(int), b: string, c: float64]
  XyzTuple* = tuple[x: SInt(int), y: string, z: float64]
...
Meter.borrowSerialization SInt(int32)
    ...
    test "objects":
      ...
      block:
        let
          ...
          c = RefTypeDerivedFromRoot(a: high(int32), b: "")
...
executeReaderWriterTests(Protobuf)
